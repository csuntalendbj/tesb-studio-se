...
public class NewOrEditDependencyDialog extends TitleAreaDialog {
    ...
    /**
     * Instantiates a new new or edit dependency dialog. Use for create a new dependency
     *
    ...
    /**
     * Instantiates a new new or edit dependency dialog. Use for edit an exist dependency
     *
     * @param input the input
     ...
     * @param type the type
     */
    public NewOrEditDependencyDialog(Collection<? extends ManifestItem> input, ManifestItem sourceItem, Shell parentShell,
            String type) {
        super(parentShell);
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        setTitle(MessageFormat
                .format(isNew ? Messages.NewDependencyItemDialog_addTitle : Messages.NewDependencyItemDialog_editTitle, name));
        setMessage(MessageFormat
                .format(isNew ? Messages.NewDependencyItemDialog_addMsg : Messages.NewDependencyItemDialog_editMsg, name));
