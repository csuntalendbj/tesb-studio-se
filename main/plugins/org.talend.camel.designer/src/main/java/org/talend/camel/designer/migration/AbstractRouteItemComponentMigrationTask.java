 ...
 */
public abstract class AbstractRouteItemComponentMigrationTask extends AbstractRouteItemMigrationTask {
    ...
    /**
     * execute migration tasks by handle node, return indicator: whether need save.
     *
     * @param node the Component node, can't not be null.
     * @return whether need save items. true: item need save, false: item not modified.
