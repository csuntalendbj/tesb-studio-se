...
public class EditRouteResourcePropertiesWizard extends PropertiesWizard {
    ...
    public EditRouteResourcePropertiesWizard(IRepositoryViewObject repositoryViewObject, IPath path, boolean useLastVersion) {
        super(repositoryViewObject, path, useLastVersion);
    }

    @Override
    public void addPages() {
        mainPage = new NewRouteResourceWizardPage("WizardPage", object.getProperty(), path, isReadOnly(), false,
                lastVersionFound) {
